...
if __name__ == "__main__":
    ...
    for i_rot, rot in enumerate((0.0, 37.0, 74.0)):
        ...
        phosim_header_map['rottelpos'] = getRotTelPos(obs.pointingRA,
                                                      obs.pointingDec,
                                                      obs,
                                                      obs.rotSkyPos)

        phosim_header_map['obshistid'] = i_rot+1

        with open(os.path.join(args.out_dir,'star_grid_%d.txt' % (i_rot+1)), 'w') as out_file:
        ...
        with open(os.path.join(args.out_dir, 'star_predicted_%d.txt' % (i_rot+1)), 'w') as out_file:
